[cybermqtt2-3f10] Operating Details
====================================

Generated On: 2024-10-14 19:56:27 UTC
...
.. important::
   ...
   **not be valid if your [cybermqtt2-3f10] container is NOT running**.

.. tip::
   You must have your [cybermqtt2-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=45789  \-\-env VIPERVIZPORT=59275  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:59275/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:59275/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   maadsdocker/cybermqtt2-3f10-amd64 (https://hub.docker.com/r/maadsdocker/cybermqtt2-3f10-amd64)
...
.. important::
   docker run -d -p 55681:55681 -p 49329:49329 -p 50533:50533 \-\-env TSS=0 \-\-env SOLUTIONNAME=cybermqtt2-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_dag-cybermqtt2-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \-\-env SOLUTIONEXTERNALPORT=55681  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=49329  \-\-env SOLUTIONVIPERVIZPORT=50533 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=45789 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=59275 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/cybermqtt2-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=50533
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=55681
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - maadsdocker/cybermqtt2-3f10-amd64
...
It can be accessed by entering: http://localhost:49329
...
.. important::
   http://localhost:50533/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:50533/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:50533/<html file>
...
[cybermqtt2-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/cybermqtt2-3f10
...
.. important::
   https://cybermqtt2-3f10.readthedocs.io
...
.. important::
   solution_preprocessing_dag-cybermqtt2-3f10
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=55681, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44387, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=42917, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=46643, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=34391, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=34359, HPDEHOST=127.0.1.1, HPDEPORT=46377, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=42495

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2319-cybermqtt2-3f10,solution_preprocessing_dag-cybermqtt2-3f10, python-preprocess-9479-cybermqtt2-3f10,solution_preprocessing_dag-cybermqtt2-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
